// Dev-time visual check: sign in as the demo admin and screenshot the four
// dispatch pages at laptop width. Run with the dev server + local Supabase up:
//   node scripts/screenshot-admin.mjs [baseUrl]
...
await page.type('input[type=email]', 'admin@citipost.test')
